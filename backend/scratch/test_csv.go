...
func bigramSimilarity(s, t string) float64 { return 0.0 } // 0 to avoid false positives

func main() {
	rawText := `Konsistensi Tanah, KONSI, 1
Kekuatan, KOFAS, 2
Frekuensi, KOLOC, (Normal)`
	...
	fmt.Printf("CSV Robust Extracted: %+v\n", extractedValues)
}
